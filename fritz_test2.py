...
if __name__ == "__main__":
    ...
    # Example usage:
    # Create a 'pdf' folder in the same directory as this script
    # and place 'a.pdf' inside it.
    current_dir = os.path.dirname(os.path.abspath(__file__))
    pdf_folder = os.path.join(current_dir, "pdf")
    pdf_file = os.path.join(pdf_folder, "a.pdf")
    
    # Output file will be named 'a.html' in the same directory as the script
    output_file = os.path.join(current_dir, "a.html")
